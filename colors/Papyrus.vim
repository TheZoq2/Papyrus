...
call s:HL("cssClassName", s:green, "", "")
  ...
  call s:HL("@keyword.import", s:blue, "", "")
  call s:HL("@keyword.repeat", s:purple, "", "bold")
  call s:HL("@keyword.conditional", s:purple, "", "bold")
  call s:HL("@label", s:aqua, "", "italic")
  call s:HL("@variable", s:foreground, "", "")
  call s:HL("@variable.parameter", s:navy, "", "")
  call s:HL("@variable.member", s:navy, "", "")
  call s:HL("@variable.builtin", s:pink, "", "")
  call s:HL("@comment.documentation", s:comment, "", "bold")
  call s:HL("@comment.todo", s:yellow, "", "")
  call s:HL("@comment.warning", s:yellow, "", "")
  call s:HL("@comment.hint", s:yellow, "", "")
  call s:HL("@comment.info", s:yellow, "", "")
  call s:HL("@namespace", s:red, "", "bold")
